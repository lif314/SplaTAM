...
# # dataset_folder="data/$dataset_name/$scene_name"
...
img_path="../data/${dataset_name}/${scene}/rgb"
...
# mkdir "$dataset_path/object_mask"
cp -r ./example/output_gaussian_dataset/${dataset_name}/Annotations "../data/${dataset_name}/${scene}/object_mask"
cd ..